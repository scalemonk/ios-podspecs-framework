Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://github.com/scalemonk/mediation-sdk-ios-framework/releases/download/scalemonk-applovinmediation-6.15.1.1/ScaleMonkAds_AppLovinMediation.zip' }
  
  s.swift_version = '5.1'
  s.ios.deployment_target = '10.0'
  s.requires_arc = true
  
  s.dependency 'ScaleMonkAds-AppLovin', s.version.to_s
