Pod::Spec.new do |s|
  ...
  s.author       = 'ScaleMonk'
  s.platform     = :ios, '9.0'
  s.source       = { :http => 'https://github.com/scalemonk/mediation-sdk-ios-framework/releases/download/1.0.0-alpha.2/SMAdsRenderer.framework.zip'}
  ...
  s.vendored_framework = "SMAdsRenderer.framework"
end
