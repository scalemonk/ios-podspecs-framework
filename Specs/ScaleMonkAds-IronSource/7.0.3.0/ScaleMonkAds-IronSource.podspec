Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://github.com/scalemonk/mediation-sdk-ios-framework/releases/download/1.0.0-alpha.1/ScaleMonkAds_IronSrouce.zip'}
  ...
  s.vendored_framework = "ScaleMonkAds_IronSrouce.xcframework"
end
